...
// first paint (stored choice → OS preference → dark); this module renders
// the nav toggle and keeps the meta theme-color in sync. The choice
// persists in localStorage under the ocur-theme key.
