// German copy for Design B ("Obsidian Glass"), as pure data — imported by
// the B runtime (src/alt/i18n.js) and by the build-time prerenderer
// (scripts/prerender-de.mjs) that bakes dist/alt/de/index.html. Mirrors the
// shape of src/strings.de.js. No browser APIs in this file.

export const TITLE_DE = 'Ocur — Das KI-Betriebssystem für Unternehmen';
export const DESC_DE =
  'Design-Vorschau B für die Ocur-Website — die Obsidian-Liquid-Glass-Richtung.';
